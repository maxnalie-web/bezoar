...
const translations: Record<string, string> = {
  ...
  newPatientAdded: "بیمار جدید",
  newDrugAdded: "دارو جدید",
  ...
  stockIn: "افزودن موجودی",
  stockOut: "کاهش موجودی",
  stockHistory: "تاریخچه موجودی",
  addStockMovement: "ثبت تغییر موجودی",
  markAsRead: "علامت‌گذاری به عنوان انجام‌شده",
  addReminder: "افزودن یادآوری",
  reminderTitle: "عنوان یادآوری",
  reminderDate: "تاریخ یادآوری",
  noStockData: "داده‌ای برای موجودی ثبت نشده",
  sortBy: "مرتب‌سازی",
  newest: "جدیدترین",
  oldest: "قدیمی‌ترین",
  ...
  sortByName: "نام (الف تا ی)",
  sortByNameDesc: "نام (ی تا الف)",
  sortByPriceAsc: "قیمت: کم به زیاد",
  sortByPriceDesc: "قیمت: زیاد به کم",
  resultsCount: "نتیجه",
